...
export default class ShippingAndBillingAddress extends LightningElement {
  ...
  getShippingAddressList() {
   ...
   /* getShippingInstruction(){
        getCartDeliveryGroup({cartId : this.strRecordId})
        .then((result)=>
        {
            console.log(result);
            this.shippingInstruction = result.ShippingInstruction;
